...
.config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/twoway', {
        templateUrl: 'partials/twoway.html'
        // no controller here
    }).when('/controlfunction', {
        templateUrl: 'partials/controlfunction.html'
        // controller class defined using directive attribute
    }).when('/loopmemory', {
        templateUrl: 'partials/loopmemory.html',
        // controller defined using directive attribute
    }).when('/artistapp', {
        templateUrl: 'partials/artistapp.html',
        // controller: '' //< controller defined using directive attribute
    }).when('/artistlist', {
        ...
        redirectTo: '/twoway' // redirected to default route
    });
}]);
...
// create module with in-memory data
myApp.controller('LoopController', function LoopController($scope) {
    $scope.artists = [{
        "name": "Ariana Yates",
        "shortname": "Ariana_Yates",
...
// create module fetch data
myApp.controller('ArtistController', ['$scope', '$http', function($scope, $http) {
